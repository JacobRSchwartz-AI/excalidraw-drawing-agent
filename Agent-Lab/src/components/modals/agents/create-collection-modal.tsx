...
/**
 * Props for the ModalUpsert component
 */
interface ModalUpsertProps {
  open: boolean;
  onClose: () => void;
}
/**
 * ModalUpsert component for creating or updating inquiries
 */
const ModalUpsertCollection: React.FC<ModalUpsertProps> = ({ open, onClose }) => {
  // State
    ...
    <CustomModal size="3xl" open={open} onClose={onClose} title={'Create Collection'}>
      <form className="space-y-4" onSubmit={handleSave}>
        <Input
          ...
          autoFocus
          subLabel="This will be the name of your collection of Agents, Capabilities, and Prompts"
          value={form.title}
