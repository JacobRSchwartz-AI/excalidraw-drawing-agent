...
import CopilotTrigger from "../packages/excalidraw/components/copilot-trigger/CopilotTrigger";
import {
  DiscordIcon,
  ExcalLogo,
  exportToPlus,
...
import { Copilot, copilotDialogState } from "./copilot";
import "./index.scss";
...
> => {
  ...
  opts.excalidrawAPI.updateScene({
    appState: { name: `Session Notes ${timestamp}` },
  });
...
const ExcalidrawWrapper = () => {
  ...
  const [, setCopilotDialogState] = useAtom(copilotDialogState);
    ...
    >
        ...
        renderTopRightUI={(isMobile) => {
          ...
          return (
            <div className="top-right-ui">
              ...
              <CopilotTrigger
                disabled={!isSignedIn}
                onSelect={() => setCopilotDialogState({ isOpen: true })}
              />
      ...
      >
        ...
        <AppWelcomeScreen
          ...
          isCollabEnabled={!isCollabDisabled}
        />
        {excalidrawAPI && <Copilot excalidrawAPI={excalidrawAPI} />}
